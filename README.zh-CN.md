...
**源码路径：** [`source/`](./source/) → Claude Code 解析恢复后的源码树  
**文档路径：** [`doc/`](./doc/) → 索引、摘要、研究笔记与模块分析
...
- hidden commands / feature flags 专题 ✅（[English](./doc/hidden-commands-feature-flags.en.md) / [中文](./doc/hidden-commands-feature-flags.zh-CN.md)）
- 权限绕过链路深挖
- remote session 协议笔记
- telemetry 隐私边界专题
- MCP auth 深挖
